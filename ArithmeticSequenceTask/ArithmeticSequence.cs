...
namespace ArithmeticSequenceTask
{
    public static class ArithmeticSequence
    {
        ...
        public static int Calculate(int number, int add, int count)
        {
            ...
            {
                throw new OverflowException("number is int.MaxValue and term more then 0.");
            }

            if (number == int.MinValue && add < 0)
            {
                throw new OverflowException("number is int.MinValue and term less then 0.");
            }
